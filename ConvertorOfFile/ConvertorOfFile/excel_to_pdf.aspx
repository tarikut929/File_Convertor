<%@ Page Language="C#" AutoEventWireup="true" CodeFile="excel_to_pdf.aspx.cs" Inherits="ConvertorOfFile.excel_to_pdf" %>
...
<body>
   ...
   <div class="text" style="right:300px;">
       ...
       <table style="float:left">
           ...
           <tr>
               <td style=" float:left"><asp:Button ID="Button1" class="btn btn-primary btn-lg" runat="server" Text="Click here" OnClick="Button_Click" /> </td>
               <td ><asp:Label ID="Result" class="btn btn-primary btn-lg" runat="server" Text=""></asp:Label></td>   
           </tr>
       </table>
