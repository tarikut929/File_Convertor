<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pdf_to_image.aspx.cs" Inherits="ConvertorOfFile.pdf_to_image" %>
...
<body>
   ...
   <div class="text" style="right:300px;">
       ...
       <table style="float:left">
           ...
           <tr>
               <td style=" float:left"><asp:Button class="btn btn-primary btn-lg" ID="Button1" runat="server" Text="Click here" OnClick="Button_Click" /> </td>
