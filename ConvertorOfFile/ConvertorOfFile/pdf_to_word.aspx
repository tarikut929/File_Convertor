<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pdf_to_word.aspx.cs" Inherits="ConvertorOfFile.pdf_to_word" %>
...
<body>
   ...
   <div class="text" style="right:300px;">
       ...
       <table style="float:left">
           ...
           <tr>
               <td style="float:left"><asp:Button ID="Button1" class="btn btn-primary btn-lg" runat="server" Text="Convert" OnClick="Button_Click" /> </td>
